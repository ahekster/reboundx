...
class build_ext(_build_ext):
    def finalize_options(self):
        ...
        sources = [ 'src/gravitational_harmonics.c', 'src/quadrupole.c', 'src/integrate_force.c', 'src/integrator_rk2.c', 'src/rebxtools.c', 'src/gas_dynamical_friction.c', 'src/gr_full.c', 'src/central_force.c', 'src/input.c', 'src/track_min_distance.c', 'src/tides_spin.c', 'src/modify_orbits_direct.c', 'src/integrator_euler.c', 'src/gr.c', 'src/output.c', 'src/modify_orbits_forces.c', 'src/interpolation.c', 'src/gas_damping_timescale.c', 'src/exponential_migration.c', 'src/integrator_rk4.c', 'src/integrator_implicit_midpoint.c', 'src/modify_mass.c', 'src/tides_constant_time_lag.c', 'src/radiation_forces.c', 'src/linkedlist.c', 'src/type_I_migration.c', 'src/gr_potential.c', 'src/core.c', 'src/steppers.c', 'src/stochastic_forces.c', 'src/yarkovsky_effect.c', 'src/lense_thirring.c', 'src/inner_disk_edge.c'],
